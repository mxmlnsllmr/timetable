  ...
  render() {
    return (
        <div className="course-preview list-group edit-remove-btns-hover">
          ...
          <h4 className="list-group-item course-preview-items" data-toggle="modal"
              data-target={this.courseID()}>{this.props.place}
            <div className="edit-remove-btns">
              <div className="glyphicon glyphicon-pencil color-blue"></div>
            </div>
          </h4>
          <CourseUpdateModal firebaseKey={this.props.firebaseKey}
                             updateCourseInFirebase={this.props.updateCourseInFirebase} id={this.modalId()}
                             courseName={this.props.name} teacher={this.props.teacher} place={this.props.place}/>
        </div>
    );
  }
}
